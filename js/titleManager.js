...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const breakTitles = [
        ...
        '⚡🧠 Mental Recharge',
        '📻 Tunes to Kick Back to'
    ];
    randomNumber = Math.random();
    let randomBreakPlaylistTitle = breakTitles[Math.floor(randomNumber * (breakTitles.length))];
    randomNumber = Math.random();
    let randomStudyPlaylistTitle = studyTitles[Math.floor(randomNumber * (studyTitles.length))];
